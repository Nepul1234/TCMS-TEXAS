...
export default function StatisticsChart() {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white px-2 pb-4 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
      ...
      <div className="w-full overflow-x-auto custom-scrollbar">
        <div className="w-full min-w-full pl-2">
