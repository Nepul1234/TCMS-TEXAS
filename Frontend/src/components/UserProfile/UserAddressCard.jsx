        ...
        const res = await fetch("/api/profileData/getSuperAdminData", {
          ...
          const data = await res.json();
            ...
            setAddress({
              ...
              postal_code: data.data.postal_code || "N/A",
              taxId: "AS4568384",
            });
...
const handleInputChange = (e) => {
  ...
  const handleSave = async() => {
    try{
      const res = fetch("/api/profile/adminProfileUpdate", {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          "Authorization": `Bearer ${token}`
            ...
            <div className="px-2 overflow-y-auto custom-scrollbar">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <Input type="text" name="postal_code" value={address.postal_code} onChange={handleInputChange} />
                </div>

                <div>
                  <Label>TAX ID</Label>
                  <Input type="text" name="taxid" placeholder="AS4568384" />
                </div>
              </div>
            </div>
