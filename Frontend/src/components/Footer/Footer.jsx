export default function Footer(){
  return (
    <div className="px-4 pt-16 bg-yellow-200 rounded-b-xl mt-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      ...
      <div className="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
        <p className="text-sm text-gray-600">
          © Copyright 2025 Texas Institute. All rights reserved.
        </p>
