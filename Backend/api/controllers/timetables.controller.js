...
export const setTimeTables = async (req, res, next) => {
    ...
    try{
        ...
        const [existingTimetable] = await pool.query('SELECT * FROM timetable WHERE content = ?', [content]);
        ...
        await pool.query('INSERT INTO timetable (grade, content) VALUES (?,?)', [gde,content]);
